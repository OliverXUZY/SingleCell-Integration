...
def main():
    ...
    ckpt_path = 'linearTorch_PCA_LR_Cluster'
    ...
    # print(f"-- Time elapsed: {time_str(time.time() - start_time)} --")
    ...
    # els = list(projections.items()) # explicitly convert to a list, in case it's Python 3.x
    # print("second to last:", els[-2])
    # print("last:", els[-1])
    # key,val =  els[-1]
    # print(key,val.shape)
    ...
    # for batch_id, (_, _, targets) in enumerate(trainloader_multi):
    #     print(projections[batch_id].shape) 
    #     outputs = model(batch_id)
    #     print(outputs.shape)
    #     # print(batch_id)
    #     # print(projections[batch_id].shape) 
