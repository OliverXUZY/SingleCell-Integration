...
multi_input = pp.readH5pyFile("/staging/syan58/open-problems-multimodal/raw/train_multi_inputs.h5") ## file1 is train_multi_inputs
# multi_target = pp.readH5pyFile("/staging/syan58/open-problems-multimodal/raw/train_multi_targets.h5") ## file2 is train_multi_targets
